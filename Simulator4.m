...
%Packet type - adicionado - Coluna 3
DATA = 0;
VOIP = 1;
...
% Initializing VoIP packets - Adicionado
for i = 1:n
...
while (TRANSMITTEDPACKETSD + TRANSMITTEDPACKETSV) < P               % Stopping criterium
    ...
    PacketType= Event_List(1,5);          %   get the packet type
    ...
    if Event == ARRIVAL         % If first event is an ARRIVAL
        ...
        if QUEUEOCCUPATION > 0
            QUEUE = sortrows(QUEUE,3,"descend");                                %SORTROWS é coerente;  descendente porque o VOIP tem valor 1 e ao ordenar por ordem descendente o VOIP aparece em primeiro lugar
